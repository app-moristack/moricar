...
class PageMetaResolver
{
    ...
    public function resolve(Request $request): PageMeta
    {
        ...
        return match ($segments[0] ?? '') {
            ...
            'for-professionals' => $this->staticPage(
                'Grow your business with MoriCar',
                'Compare MoriCar plans for individual professionals, agencies and companies in Mauritius.',
            ),
            ...
            'about' => $this->staticPage(
                'About MoriCar',
                'MoriCar connects people in Mauritius with reviewed construction, renovation and home-service professionals.',
            ),
            'contact' => $this->staticPage('Contact MoriCar', 'Get in touch with the MoriCar team.'),
            'terms' => $this->staticPage('Terms of use', 'The terms that govern the use of MoriCar.'),
            'privacy' => $this->staticPage('Privacy policy', 'How MoriCar collects, uses and protects your data.'),
            'install' => $this->staticPage(
                'Install MoriCar on your phone',
                'Add MoriCar to your iPhone or Android home screen and use it like an app.',
            ),
    ...
    private function home(): PageMeta
    {
        ...
        return new PageMeta(
            title: 'MoriCar — Find trusted construction & renovation professionals in Mauritius',
    ...
    private function search(Request $request): PageMeta
    {
        ...
        $title = $label === ''
            ? 'Search professionals near you — MoriCar'
            : Str::title($label).' — MoriCar';
    ...
    private function provider(?string $slug): PageMeta
    {
        ...
        if ($provider === null) {
            return new PageMeta(
                title: 'Profile not found — MoriCar',
        ...
        return new PageMeta(
            title: "{$provider->name} — {$services} in {$provider->locality} | MoriCar",
