...
class SpaController extends Controller
{
    ...
    {
        $search = config('moricar.search');

        return [
            'appName' => config('app.name'),
            'supportEmail' => config('moricar.support_email'),
            'supportWhatsapp' => config('moricar.support_whatsapp'),
            ...
            'whatsappTemplate' => config('moricar.whatsapp.message_template'),
        ];
    }
}
