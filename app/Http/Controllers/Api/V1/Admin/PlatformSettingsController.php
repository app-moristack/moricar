...
class PlatformSettingsController extends Controller
{
    ...
    private function currentSettings(): array
    {
        ...
        $defaults = [
            ...
            'support_email' => config('moricar.support_email'),
            'support_whatsapp' => config('moricar.support_whatsapp'),
            'whatsapp_message_template' => config('moricar.whatsapp.message_template'),
        ];
