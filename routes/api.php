...
use App\Http\Controllers\Api\V1\Public\CarSearchController;
use App\Http\Controllers\Api\V1\Public\PublicCarsController;
...
Route::prefix('v1')->group(function () {
    ...
    Route::middleware('throttle:public')->group(function () {
        ...
        Route::get('cars/featured', [PublicCarsController::class, 'featured']);
        Route::get('cars/{car:slug}', [PublicCarsController::class, 'show']);
