...
export function InstallPrompt() {
  ...
  const handleInstall = async () => {
    ...
    if (accepted) {
      showToast('MoriCar is being added to your home screen.', 'success')
    }
  }
    ...
    >
      <div className="card animate-rise mx-auto flex max-w-md items-start gap-3 p-4 shadow-lifted">
        ...
        <div className="min-w-0 flex-1">
          <p className="text-sm font-bold text-ink-900">Add MoriCar to your home screen</p>
