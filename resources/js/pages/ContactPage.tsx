...
const FAQS = [
  ...
  {
    icon: Settings,
    question: 'Is MoriCar free to use?',
    answer:
      'Yes. Finding and contacting professionals is free for customers. MoriCar is also free for individual and self-employed professionals. Agencies and companies pay a yearly subscription, with no commitment or credit card required. Payment is made through Juice to activate the account.',
  },
  {
    icon: CircleHelp,
...
export default function ContactPage() {
  ...
  return (
    <div className="contact-page">
      ...
      <section className="container-page contact-main" aria-label="Contact MoriCar">
