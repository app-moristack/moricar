...
import phoneImage from '../../images/moricar-mobile-app-welcome.webp'
import roomImage from '../../images/mauritius-home-renovation-living-room.webp'
import '../../css/install.css'

const IOS_STEPS = [
  { title: 'Open MoriCar in Safari.', detail: 'Use Safari on your iPhone or iPad.' },
  ...
  { title: 'Tap “Add”.', detail: 'MoriCar will appear on your home screen.' },
]
const ANDROID_STEPS = [
  { title: 'Open MoriCar in Chrome.', detail: 'Visit this website on your Android phone.' },
  ...
  { title: 'Confirm, and you’re all set.', detail: 'Open MoriCar directly from your home screen.' },
]
    ...
    <div className={`install-phone ${android ? 'install-phone-android' : ''}`} aria-hidden="true">
      ...
      <div className="install-phone-screen">
        ...
        <div className="install-phone-url">
          <ShieldCheck size={9} /> moricar.mu <MoreVertical size={10} />
        </div>
        <div className="install-phone-brand">
          <img src="/icons/icon-96.png" alt="" />
          <strong>MoriCar</strong>
        </div>
        {android ? (
...
export default function InstallPage() {
  ...
  const handleInstall = async () => {
    ...
    try {
      ...
      setMessage(
        accepted
          ? 'MoriCar is being added to your home screen.'
      ...
      <section className="install-hero" aria-labelledby="install-title">
        ...
        <div className="container-page install-hero-inner">
          <div className="install-hero-copy">
            ...
            <p>
              Get quick access to MoriCar, just like a native app. Full screen, no browser bar, and one tap
          ...
          <img
            ...
            alt="MoriCar app on a phone, with a view of Le Morne"
          />
        ...
        {isStandalone ? (
          <div className="install-native-status" role="status">
            ...
            <div>
              ...
              <p>You’re using MoriCar as an app. Everything is ready.</p>
            </div>
          </div>
        ) : canPromptNatively ? (
          <div className="install-native-status">
            <div>
              <strong>Your browser is ready to install MoriCar.</strong>
          ...
          <section className="install-guide" aria-labelledby="ios-install-title">
            <header>
              ...
              <div>
                ...
                <p>Install MoriCar using Safari</p>
              </div>
          ...
          <section className="install-guide" aria-labelledby="android-install-title">
            <header>
              ...
              <div>
                ...
                <p>Install MoriCar using Chrome</p>
              </div>
