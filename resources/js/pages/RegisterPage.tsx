...
import individualHero from '../../images/Grow your business with MoriCar.png'
...
export default function RegisterPage({ providerType }: RegisterPageProps) {
  ...
  const title = isBusiness ? 'Register Your Business on MoriCar' : 'Join MoriCar as an Individual'
    ...
    <div className={`professional-register-page ${isBusiness ? 'business-register' : ''}`}>
      ...
      {isBusiness ? (
        <section className="container-page business-offer">
          <div>
            <strong>MoriCar Business Plan</strong>
      ...
      <section className="container-page register-content">
        ...
        <aside className="register-benefits-card">
          ...
          <h2>{isBusiness ? 'Your business subscription includes' : 'MoriCar is free for individuals'}</h2>
          <p>
            {isBusiness
