    ...
    <div className="about-page">
        ...
        <div className="container-page relative">
          <div className="about-hero-copy">
            ...
            <p className="about-intro">
              MoriCar connects you with trusted local professionals for construction, renovation, repairs and
      ...
      <section className="container-page about-story" aria-labelledby="story-title">
        <div>
          ...
          <p>
            MoriCar was born from a simple idea: to make it easier for homeowners and businesses in Mauritius
          ...
          <p>
            ...
            a major renovation. That’s why we created MoriCar: a platform that brings together trusted local
      ...
      <section className="about-moristack" aria-labelledby="moristack-title">
        ...
        <div className="container-page about-moristack-grid">
          <div>
            ...
            <p>
              MoriCar is a product of MoriStack, a Mauritius-based tech company passionate about creating
              digital solutions that make a real difference in people’s lives. Through innovative platforms
              like MoriCar, we aim to empower local communities, support businesses, and build a smarter,
