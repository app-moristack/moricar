...
import heroImage from '../../images/Grow your business with MoriCar.png'
...
const BUSINESS_BENEFITS = [
  ...
  'Featured on the MoriCar homepage',
    ...
    <div className="professionals-page">
      ...
      <section className="container-page pro-plans" aria-label="Choose your professional plan">
        ...
        <article className="pro-plan-card business-plan">
          ...
          <p>Give your business greater visibility on MoriCar.</p>
      ...
      <section className="container-page pro-why">
        <p className="pro-eyebrow">Why join MoriCar?</p>
