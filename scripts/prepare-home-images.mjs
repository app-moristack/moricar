...
const images = [
  ...
  ['phone screen 1.png', 'moricar-mobile-app-welcome', 600],
  ['phone screen 2.png', 'moricar-mobile-app-professional-search', 600],
  ['logo.png', 'moricar-house-services-logo', 180],
  ['logo-alt.png', 'moricar-wordmark', 520],
  ['brand.png', 'moricar-local-professionals-brand', 480],
]
