...
class AdminSeederTest extends TestCase
{
    ...
    {
        config(['moricar.admin.email' => 'admin@moricar.mu', 'moricar.admin.password' => 'test-admin-password']);
        $oldAdmin = User::factory()->create(['phone' => config('moricar.support_whatsapp')]);
        ...
        $admin = User::where('email', 'admin@moricar.mu')->sole();
        ...
        config(['moricar.admin.password' => 'updated-test-password']);
        $this->seed(AdminSeeder::class);
